...
Changes: 
    ...
    - tensorflow.keras.backend.image_dim_ordering is now tensorflow.keras.backend.image_data_format()
    - Updated dim_ordering, now 'th' = 'channels_first' and 'tf' = 'channels_last'
